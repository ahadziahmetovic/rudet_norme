...
$("#unesi").click(function () {
  ...
  var tr_str = "<tr>" +
    ...
    "<td align='center'><button id='editbtn' class='btn btn-primary d-flex justify-content-end'>Briši</button></td>" +
...
$("#slanje").on("click", function (e) {
  ...
  $.ajax({
    ...
    dataType: 'json',
    type: 'POST',
    data: JSON.stringify({ podaci: myData, nalog_naziv: nalog_naziv }),
    contentType: false,
    processData: false,
