...
"<td align='center' style='display:none;'>" + proizvod_id + "</td>" +
 "<td align='center'>" + proizvod + "</td>" +
  ...
  "<td align='center' style='display:none;'>" + datum + "</td>" +
  "<td align='center' style='display:none;'>" + series_id + "</td>" +
  "<td align='center' style='display:none;'>" + operation_id + "</td>" +
  "<td align='center'>" + masina + "</td>" +
  "<td><button id='editbtn' class='btn btn-primary d-flex justify-content-end'>Briši</button></td>" +  
  ...
  //myData.push(broj);
   ...
   console.log('Slanje'+myDataN);
    ...
    $.ajax({
      ...
      data: JSON.stringify({podaci:myData}),
      contentType: false,
      processData: false,
      success:function(response) {
